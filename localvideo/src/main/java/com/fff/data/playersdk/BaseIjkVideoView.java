package com.fff.data.playersdk;
...
import com.fff.data.controller.BaseVideoController;
import com.fff.data.controller.MediaPlayerControl;
import com.fff.data.listener.OnVideoViewStateChangeListener;
import com.fff.data.listener.PlayerEventListener;
import com.fff.data.util.ProgressUtil;
import com.fff.data.util.WindowUtil;
...
public abstract class BaseIjkVideoView extends FrameLayout implements MediaPlayerControl, PlayerEventListener {
    ...
    protected void initPlayer() {
        if (mMediaPlayer == null) {
            if (mPlayerConfig.mAbstractPlayer != null) {
                ...
                mMediaPlayer = new myIjkPlayer(getContext());
            }
    ...
    protected void startPrepare(boolean needReset) {
        ...
        if (needReset) {
            mMediaPlayer.reset();
            if (!(mMediaPlayer instanceof myIjkPlayer)) {
                mMediaPlayer.bindVideoView(this);
                addDisplay();
            }
        }
